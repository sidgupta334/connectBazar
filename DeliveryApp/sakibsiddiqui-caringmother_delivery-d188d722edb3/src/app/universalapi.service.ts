...
export class UniversalapiService {
  ...
  static url = 'http://13.232.166.177:8080';
...
user: any;
  ...
  getClosedOrderList() {
    ...
    console.log(id);
    return this.http.get<any>(UniversalapiService.url + '/order/vendor/orders/closed/' + id, {headers}).pipe(map(res => res));
  }
  ...
  getOpenOrderList() {
    ...
    const id = this.user.userId;
    console.log(id);
    return this.http.get<any>(UniversalapiService.url + '/order/vendor/allOrders/' + id, {headers}).pipe(map(res => res));
  }
  ...
  headers = headers.set('token', localStorage.getItem('grocericaVendortoken'));
  console.log(id);
  return this.http.get<any>(UniversalapiService.url + '/order/view/' + id, {headers}).pipe(map(res => res));
  }
  ...
  markDelivered(orderId) {
    ...
    headers = headers.set('token', localStorage.getItem('grocericaVendortoken'));
    console.log(orderId);
    return this.http.get<any>(UniversalapiService.url + '/order/deliver/' + orderId, {headers}).pipe(map(res => res));
  }
