...
/* harmony import */ var _profile_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./profile.service */ "./src/app/profile/profile.service.ts");
...
ProfilePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [_commom_service__WEBPACK_IMPORTED_MODULE_7__["CommomService"],
            _profile_service__WEBPACK_IMPORTED_MODULE_8__["ProfileService"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["DatePipe"]
        ],
...
/* harmony import */ var _profile_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./profile.service */ "./src/app/profile/profile.service.ts");
...
let ProfilePage = class ProfilePage {
    constructor(common, formBuilder, datePipe, loadingController, api) {
        this.common = common;
...
let ProfileService = class ProfileService {
    ...
    getUserDetails() {
        ...
        return this.http.get(this.baseUrl + '/users/me', { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
    updateProfile(value) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers = headers.set('token', localStorage.getItem('grocericaVendortoken'));
        ...
        return this.http.post(this.baseUrl + '/users/update', param, { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
};
