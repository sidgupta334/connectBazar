...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["order-order-module"], {
  ...
  function srcAppOrderOrderModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _order_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./order.page */
    "./src/app/order/order.page.ts");
    ...
    OrderPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _order_routing_module__WEBPACK_IMPORTED_MODULE_7__["OrderPageRoutingModule"]],
  ...
  function srcAppOrderOrderPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _universalapi_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var OrderPage = /*#__PURE__*/function () {
      function OrderPage(common, geolocation, api, launch, loadingController, router, nativeGeocoder) {
      ...
      _createClass(OrderPage, [{
        ...
        value: function getProductList() {
          ...
          var p = this.api.getOrderVendor(this.id);
          p.subscribe(function (res) {
            _this.viewOrder = res; // get the status of cancelled

            if (_this.viewOrder.orderStatus === 'CANCELLED_COD' || _this.viewOrder.orderStatus === 'CANCELLED_ONLINE') {
              _this.viewOrder.orderStatus = 'CANCELLED';
            }

            _this.viewOrder.discountReceived = _this.viewOrder.oldTotal - (_this.viewOrder.finalTotal + _this.viewOrder.discountApplied);
            _this.viewOrder.netAmount = _this.viewOrder.oldTotal - _this.viewOrder.discountReceived;

            for (var i = 0; i < _this.viewOrder.products.length; i++) {
              // calc total of particular product
              _this.viewOrder.products[i].total = _this.viewOrder.products[i].newPrice * _this.viewOrder.products[i].quantity; // calc the discount on each product

              _this.viewOrder.products[i].discount = _this.viewOrder.products[i].oldPrice * _this.viewOrder.products[i].quantity - _this.viewOrder.products[i].total; // calc the total discount of product list
        ...
        value: function navigate() {
          ...
          this.launch.navigate('' + this.viewOrder.lattitude + ',' + this.viewOrder.longitude + ',ON', options).then(function (success) {
        ...
        key: "orderDelivered",
        value: function orderDelivered(item) {
          var _this2 = this;

          var p = this.api.markDelivered(item.orderId);
          p.subscribe(function (res) {
            _this2.common.presentToast('Order Deliverd');
