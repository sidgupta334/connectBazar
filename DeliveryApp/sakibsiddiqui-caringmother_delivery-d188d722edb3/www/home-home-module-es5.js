...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HomePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_5__["HomePageRoutingModule"]],
      providers: [_login_login_service__WEBPACK_IMPORTED_MODULE_7__["LoginService"], _ionic_native_network_ngx__WEBPACK_IMPORTED_MODULE_9__["Network"]],
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _universalapi_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(alert, router, modalController, statusBar, homePageApi, commom, network, loadingController, api, platform) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    ...
                    p = this.homePageApi.getOpenOrderList();
                    p.subscribe(function (res) {
                      _this2.orderList = res; //method to sort in ascending order
                      ...
                      for (var i = 0; i < _this2.orderList.length; i++) {
                        if (_this2.orderList[i].orderStatus === 'CANCELLED_COD' || _this2.orderList[i].orderStatus === 'CANCELLED_ONLINE') {
                          _this2.orderList[i].orderStatus = 'CANCELLED';
                        }
                      }
                    }, function (error) {
