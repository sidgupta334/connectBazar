...
let LoginPage = class LoginPage {
    constructor(fb, http, api, alert, statusBar, router, loadingController) {
        this.fb = fb;
        this.http = http;
        this.api = api;
        this.alert = alert;
